...
def upgrade() -> None:
    ...
    sa.CheckConstraint("status IN ('new', 'active', 'archive', 'banned')", name='chk_users_status'),
    sa.CheckConstraint('phone IS NOT NULL OR email IS NOT NULL', name='chk_users_phone_or_email'),
    ...
    op.create_table('users_location',
    sa.Column('user_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_users_location_location', table_name='users_location', postgresql_using='gist')
