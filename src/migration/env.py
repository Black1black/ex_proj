...
# нужно чтобы корректно работали импорты для алембика, ведь они на уровень выше
...
# Исключаемые таблицы из наблюдения для миграций
def exclude_table(object, name, type_, reflected, compare_to):
